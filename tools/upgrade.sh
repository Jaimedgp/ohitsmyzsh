...
git remote -v | while read remote url extra; do
  case "$url" in
  https://github.com/jaimedgp/ohitsmyzsh(|.git))
    git remote set-url "$remote" "https://github.com/jaimedgp/ohitsmyzsh.git"
    break ;;
  git@github.com:robbyrussell/ohitsmyzsh(|.git))
    git remote set-url "$remote" "git@github.com:jaimedgp/ohitsmyzsh.git"
    break ;;
